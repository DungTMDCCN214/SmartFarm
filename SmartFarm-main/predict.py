...
PLANT_CONFIG = {
    "cam": {
        "model_path": r"D:/TTCS/APP/models/Cay_cam_model.keras",
        "class_names": [
            "Vang_la_gan_xanh",
            "benh_loet", 
            "la_khoe", 
    ...
    "chanh": {
        "model_path": r"D:/TTCS/APP/models/Cay_chanh_model.keras",
        "class_names": [
            "La_khoe", 
            "La_vang_thoi_re", 
            "Lo_loet", 
    ...
    "dua_hau": {
        "model_path": r"D:/TTCS/APP/models/Cay_dua_hau_model.keras",
        "class_names": [
            "Benh_suong_mai", 
            "Benh_than_thu", 
            "La_khoe_manh", 
    ...
    "le": {
        "model_path": r"D:/TTCS/APP/models/Cay_le_model.keras",
        "class_names": [
            "Chay_la", 
            "Dom_la", 
            "La_khoe", 
    ...
    "oi": {
        "model_path": r"D:/TTCS/APP/models/Cay_oi_model.keras",
        "class_names": [
            "La_khoe", 
            "Loet", 
            "Than_thu", 
    ...
    "xoai": {
        "model_path": r"D:/TTCS/APP/models/Cay_xoai_model.keras",
        "class_names": [
    ...
    "thanh_long": {
        "model_path": r"D:/TTCS/APP/models/dragonfruit_model.keras",
        "class_names": [
            "benh_dom_den",
            "benh_dom_nau",
            "benh_thoi_re",
    ...
    "buoi": {
        "model_path": r"D:/TTCS/APP/models/citrus_model.keras",
        "class_names": [
            "benh_dom_den",
            "benh_loet_vikhuan",
    ...
    "vai": {
        "model_path": r"D:/TTCS/APP/models/lychee_model.keras",
        "class_names": [
            "benh_phan_trang",
            "benh_suong_mai",
            "benh_than_thu",
